...
" ============================================================================
let s:VimLint_version = '0.0.7'  " alpha, unreleased

" History:{{{1
" v.0.0.7 changes:
" * moved to Vim's autoload architecture. (thanks, MarcWeber)
"   VimLint is now available through MarcWeber's vim-addon-manager plugin:
